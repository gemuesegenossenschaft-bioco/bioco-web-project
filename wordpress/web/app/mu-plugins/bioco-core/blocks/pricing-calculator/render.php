...
$eyebrow = bioco_field('eyebrow');
$title = bioco_field('title');
$text = bioco_field('text');
$share_price = (int) (bioco_field('share_price') ?: 250);
$work_suffix = bioco_field('work_suffix');
$signup_url = bioco_field('signup_url');
$shares_only_label = bioco_field('shares_only_label');
$annual_contribution_label = bioco_field('annual_contribution_label');
$work_label = bioco_field('work_label');
$one_time_payment_label = bioco_field('one_time_payment_label');
$additional_shares_label = bioco_field('additional_shares_label');
$cta_label = bioco_field('cta_label');
$cta_note = bioco_field('cta_note');
$recommended_label = bioco_field('recommended_label');
$no_subscription_label = bioco_field('no_subscription_label');
$article_label = bioco_field('article_label');
$quantity_label = bioco_field('quantity_label');
$unit_price_label = bioco_field('unit_price_label');
$total_label = bioco_field('total_label');
$share_certificates_label = bioco_field('share_certificates_label');
$required_label = bioco_field('required_label');
$shares_only_info = bioco_field('shares_only_info');
$without_basket_label = bioco_field('without_basket_label');
$additional_label = bioco_field('additional_label');
$tiers = bioco_field('tiers');
