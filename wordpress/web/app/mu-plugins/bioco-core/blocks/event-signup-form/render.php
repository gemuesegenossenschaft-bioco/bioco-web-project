...
$formStrings = [
    ...
    'transportError' => (string) bioco_field('transport_error'),
];
bioco_forms_localize_block('bioco/event-signup-form', 'biocoEventSignupFormConfig', 'event-signup', $formStrings);
