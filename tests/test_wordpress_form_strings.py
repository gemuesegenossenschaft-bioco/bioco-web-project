...
Du-Anrede wie auf der Live-Site.
Testflächen: tests/README.md, Keep/Replace/Remove-Karte. Der Editor kann jeden Text ohne Deploy
aendern.
"""
...
def test_localized_config_reaches_the_form_via_marker_expansion():
    ...
    function rest_url($path) { return 'https://staging.test/wp-json/' . $path; }
